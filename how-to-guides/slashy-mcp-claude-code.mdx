...
<Steps>
  <Step title="Run the add command">
    ...
    <Frame>
      <img src="/images/mcp/claude-code-terminal.png" alt="Claude Code terminal running the add command" style={{width: "100%", maxWidth: "700px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Approve OAuth in your browser">
    ...
    <Frame>
      <img src="/images/mcp/claude-code-oauth.png" alt="Slashy OAuth approval screen" style={{width: "100%", maxWidth: "500px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Verify the connection">
    ...
    <Frame>
      <img src="/images/mcp/claude-code-verify.png" alt="Claude Code mcp list output" style={{width: "100%", maxWidth: "700px", margin: "0 auto"}} />
    </Frame>
  </Step>
</Steps>
