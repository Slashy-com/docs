...
seoDescription: "Overview of Slashy MCP: connect Slashy's email, calendar, and research tools to Claude Code, Claude Desktop, Claude on the web, Cursor, and Codex CLI via Model Context Protocol."
---

Slashy MCP lets your favorite AI tools - Claude Code, Claude Desktop, Claude on the web, Cursor, and Codex - use Slashy's email, calendar, and research tools directly. This section walks you through the basics before you pick a client to set up.
...
- One of the supported clients installed:
  - Claude Code
  - Claude Desktop or Claude on the web (claude.ai)
  - Cursor
  - Codex CLI
...
<Steps>
  <Step title="Try the Agent Plugin first">
    If you use Codex, Cursor, VS Code, or GitHub Copilot, [install the Slashy Agent Plugin](/how-to-guides/slashy-mcp-plugin) - it sets up the MCP server **and** the Slashy skill in one step, with no config to paste. Then skip to step 3.

    Claude Code, Claude Desktop, and claude.ai don't support Agent Plugins yet, so continue below for those.
  </Step>

  <Step title="Or pick your client">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Claude App & Web" icon="desktop" href="/how-to-guides/slashy-mcp-claude-desktop">
        Add a custom connector in Claude Desktop or on claude.ai.
      </Card>
