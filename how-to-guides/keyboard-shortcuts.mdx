...
seoDescription: "Complete Slashy keyboard shortcuts reference -- navigation, composing, calendar, AI agent, search, and inbox management. Printable cheatsheet."
---

Slashy is built around the keyboard. Press `Shift+?` anytime to open the shortcut overlay.

<Frame>
  <img src="/images/screenshots/keyboard-shortcuts-cheatsheet.png" alt="Slashy keyboard shortcuts reference panel showing navigation, compose, and action shortcuts" />
</Frame>
