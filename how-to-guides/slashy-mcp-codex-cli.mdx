...
<Steps>
  <Step title="Open the Codex config file">
    ...
    <Frame>
      <img src="/images/mcp/codex-edit-config.png" alt="Terminal editing ~/.codex/config.toml" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Add the Slashy server">
    ...
    <Frame>
      <img src="/images/mcp/codex-config.png" alt="Codex config.toml with Slashy block" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Start Codex and approve OAuth">
    ...
    <Frame>
      <img src="/images/mcp/codex-oauth.png" alt="Codex CLI launching + OAuth popup" style={{width: "100%", maxWidth: "700px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Verify the connection">
    ...
    <Frame>
      <img src="/images/mcp/codex-verify.png" alt="Codex /mcp output showing Slashy connected" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
</Steps>
