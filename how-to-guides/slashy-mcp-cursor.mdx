...
<Steps>
  <Step title="Open MCP settings">
    ...
    <Frame>
      <img src="/images/mcp/cursor-settings.png" alt="Cursor MCP settings panel" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Add Slashy to your config">
    ...
    <Frame>
      <img src="/images/mcp/cursor-config.png" alt="Cursor mcp.json file with Slashy entry" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Restart Cursor and approve OAuth">
    ...
    <Frame>
      <img src="/images/mcp/cursor-oauth.png" alt="Cursor restart + OAuth approval" style={{width: "100%", maxWidth: "500px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Verify the connection">
    ...
    <Frame>
      <img src="/images/mcp/cursor-verify.png" alt="Cursor MCP panel showing Slashy connected" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
</Steps>
