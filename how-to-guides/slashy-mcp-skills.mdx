...
The maintained Slashy skill lives at [Slashy-com/skills](https://github.com/Slashy-com/skills). Install it without copying anything:

```bash
npx skills add Slashy-com/skills
```

That works with Claude Code, Cursor, Codex, Copilot, Windsurf, and anything else the [skills CLI](https://skills.sh) supports. You'll still need to [connect the MCP server](/how-to-guides/slashy-mcp-overview) separately.

Better still, if your client supports it: the [Slashy Agent Plugin](/how-to-guides/slashy-mcp-plugin) installs this same skill **and** the MCP server together.

The rest of this page covers writing the skill by hand, for clients that support neither.
