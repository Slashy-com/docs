...
Slashy tools return deep links that jump straight to the relevant thread, draft, or event in the Slashy app. Ask for them explicitly and Claude will include a clickable link in the answer.
...
> *"Show my calendar for tomorrow with a Slashy link next to each event."*

<Tip>Make "give me Slashy links" part of your auto-use prompt if you always want them -- it saves typing the instruction every time.</Tip>
