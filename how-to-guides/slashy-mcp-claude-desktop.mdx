...
<Steps>
  <Step title="Open Settings → Connectors">
    ...
    <Frame>
      <img src="/images/mcp/claude-desktop-settings.png" alt="Claude Desktop Connectors settings" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Add the custom connector">
    ...
    <Frame>
      <img src="/images/mcp/claude-desktop-form.png" alt="Claude Desktop Add Custom Connector form" style={{width: "100%", maxWidth: "600px", margin: "0 auto"}} />
    </Frame>
  </Step>
  ...
  <Step title="Approve OAuth">
    ...
    <Frame>
      <img src="/images/mcp/claude-desktop-oauth.png" alt="Slashy OAuth approval in Claude Desktop" style={{width: "100%", maxWidth: "800px", margin: "0 auto"}} />
    </Frame>
  </Step>
