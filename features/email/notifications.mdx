...
seoDescription: "Configure Slashy notification preferences with per-label triggers, desktop and mobile push settings, badge counts, calendar alerts, and focus mode suppression."
---
